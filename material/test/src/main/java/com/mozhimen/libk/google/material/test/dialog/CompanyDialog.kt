package com.mozhimen.libk.google.material.test.dialog
...
import com.mozhimen.libk.google.material.test.databinding.DialogCompanyBinding
...
class CompanyDialog(private val companyMap: Map<String, Int>, private val selectedTabPosition: Int) : BottomSheetDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(STYLE_NORMAL, com.mozhimen.xmlk.R.style.ThemeK_Design_Light_BottomSheetDialog)
    }
